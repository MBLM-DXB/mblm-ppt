...
10. **Content-slide titles** (incl. Agenda): **`BentonSansCond-Light` 40pt only** (SVG **53.3** = 40/0.75; face in font-family); top edge at
    **1.05 cm**.
...
| Type | **`BentonSansCond-Light`** titles (40pt content / 60–72 cover); **`BentonSansCond-Regular`** body 16–18; PostScript face in font-family (not weight alone); **no Medium** |
