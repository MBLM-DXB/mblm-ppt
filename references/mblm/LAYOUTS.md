...
| `MBLM_title_content.svg` | Title + body | Light title **47pt** + Regular body; no kicker; margins v4.1 |
...
| J Agenda / Content TOC ★ | `title_content` / custom — mimic r2_12 |
...
2. Agenda / overview — **Pattern J (r2_12)** and/or **K (r2_40)**; also H/I pillars  
...
- Content titles: BentonSansCond Light **47pt only** (incl. Agenda “Content”)
