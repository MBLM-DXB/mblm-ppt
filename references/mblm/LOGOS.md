...
Bundled lockups live in `${SKILL_DIR}/assets/mblm/logos/`. **v4.1.0 persistent geometry** — see [`LAYOUT_METRICS.md`](LAYOUT_METRICS.md) for cm + px. Visual examples: specs 03–04, 13–16, 34+; R2 content slides (logo top-right, no tagline).
