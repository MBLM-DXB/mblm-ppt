...
| Role | Rule |
|---|---|
| **Content page title** | **`BentonSansCond-Light` 40pt only** (SVG **53.3**; PostScript face in font-family) — never 47/54/24–36 |
...
4. Every content title: `font-family` starts with **`BentonSansCond-Light`**; `font-size="53.3"` (scaled) or `"40"` (unscaled pt-as-SVG); top edge at **1.05 cm / ≈39.7**; left at margin.  
